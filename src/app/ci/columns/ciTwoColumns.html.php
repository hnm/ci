...
?>
<div class="row ci-col ci-2-col<?php $html->out($isMultiNested ? ' ci-has-multi': '') ?>">
	<div class="col-md-6<?php $html->out($isMultiNested ? '' : ' d-flex flex-column') ?> ci-2-col-left">
		<?php $ciHtml->contentItems($contentItems, NestedContentItem::NESTED_PANEL_NAME_1) ?>
	</div>
	<div class="col-md-6<?php $html->out($isMultiNested ? '' : ' d-flex flex-column') ?> ci-2-col-right">
